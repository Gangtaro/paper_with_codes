...
class SelfAttention(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask, weight_mask = None):
...
class Encoder(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, weight_mask, output_all_encoded_layers=True):
        all_encoder_layers = []
        for layer_module in self.layer:
            hidden_states = layer_module(hidden_states, attention_mask, weight_mask)
